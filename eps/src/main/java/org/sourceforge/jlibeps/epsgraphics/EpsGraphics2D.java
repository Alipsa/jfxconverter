...
public class EpsGraphics2D extends Graphics2D {
    ...
    * @since 1.1.5
    */
   public EpsGraphics2D(final Writer writer, final String title, final double minX, final double minY, final double maxX, final double maxY, final ColorMode colorMode) throws IOException {
