...
public class CharsetMatch implements Comparable<CharsetMatch> {
    ...
    * @return a negative integer, zero, or a positive integer as the confidence level of this CharsetMatch
    * is less than, equal to, or greater than that of the argument.
