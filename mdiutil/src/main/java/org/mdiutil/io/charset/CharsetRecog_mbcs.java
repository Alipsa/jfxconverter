 ...
 * encoding scheme for the charset, and, optionally, frequency-of-occurence of characters.
 * <p/>
 * Instances of this class are singletons, one per encoding being recognized. They are created in the main
 * CharsetDetector class and kept in the global list of available encodings to be checked. The specific
 * encoding being recognized is determined by subclass.
 *
 * @since 0.9.22
 */
