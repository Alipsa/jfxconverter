 ...
 * @since 1.2.10
 */
public class ZipStreamHandler extends java.net.URLStreamHandler {
   ...
   protected boolean sameFile(URL u1, URL u2) {
      if (!u1.getProtocol().equals("zip") || !u2.getProtocol().equals("zip")) {
         return false;
      }
   ...
   protected void parseURL(URL url, String spec, int start, int limit) {
      ...
      boolean absoluteSpec = spec.length() >= 4
         ? spec.regionMatches(true, 0, "zip:", 0, 4)
         : false;
