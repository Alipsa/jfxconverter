...
@Category(cat = "xml")
public class XMLSAXParser9KOTest extends ResolverSAXHandler {
   private boolean foundChild = false;

   public XMLSAXParser9KOTest() {
   }
   ...
   public void testParseWithValidation() {
      ...
      URL xsdURL = XMLSAXParser9KOTest.class.getResource("resources/testIncludeXSD2.xsd");
      ...
      URL xmlURL = XMLSAXParser9KOTest.class.getResource("resources/testKO2.xml");
      parser.parse(xmlURL);
