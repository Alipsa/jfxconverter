...
@Category(cat = "xml")
public class XMLSAXParserRevertTest {

   public XMLSAXParserRevertTest() {
   }

   @BeforeClass
   public static void setUpClass() {
      XMLSAXParser.revertOldReaderBehavior(true);
      XMLSAXParser.setDefaultAllowNestableConnections(true);
   }
   ...
   public void testParseWithoutValidation() {
      System.out.println("XMLSAXParserRevertTest : testParseWithoutValidation");
      ...
      URL xmlURL = XMLSAXParserRevertTest.class.getResource("resources/simpleXMLWithoutDTD.xml");
      parser.parse(xmlURL);
   ...
   public void testParseWithReader2() throws IOException {
      ...
      URL xmlURL = XMLSAXParserRevertTest.class.getResource("resources/simpleXMLWithoutDTD2.xml");
