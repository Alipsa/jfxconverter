...
/**
 * Test the XMLNodeUtilities2 print method with comments.
 *
 * @since 1.2.39.6
 */
...
public class XMLNodeUtilities2PrintCommentsTest {

   public XMLNodeUtilities2PrintCommentsTest() {
   }
   ...
   public void testPrint() {
      System.out.println("XMLNodeUtilities2PrintCommentsTest : testPrint");
