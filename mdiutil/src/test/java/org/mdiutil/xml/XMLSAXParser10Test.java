...
@Category(cat = "xml")
public class XMLSAXParser10Test extends ResolverSAXHandler {
   ...
   public void testParseWithoutValidation() {
      System.out.println("XMLSAXParser10Test : testParseWithoutValidation");
      ...
      URL xmlURL = XMLSAXParser10Test.class.getResource("resources/testIncludeParent2.xml");
      parser.parse(xmlURL);
