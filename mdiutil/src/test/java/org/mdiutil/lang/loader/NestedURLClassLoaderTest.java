...
public class NestedURLClassLoaderTest {
   ...
   public void testLoadClass() throws Exception {
      System.out.println("NestedURLClassLoader : testLoadClass");
      URL zipUrl = this.getClass().getResource("/testutils/testEmbedZipped.zip");
   ...
   /**
    * Test of Class.forName method, of class URLClassLoader.
    */
   @Test
   public void testLoadClassDefault() throws Exception {
      System.out.println("NestedURLClassLoader : testLoadClassDefault");
      ...
      try {
         ...
         Class.forName("org.testutils.embed.EmbeddedClass", true, loader);
      } catch (ClassNotFoundException e) {
         System.out.println(e.toString() + " : normal exception when using URLClassLoader");
      }
   }
}
